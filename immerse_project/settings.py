"""
Django settings for immerse_project project.
...
SECRET_KEY = 'django-insecure-eni3-$mv4+&s3^y#@oa0**31k)c4v=-caw1!!bgw%o5yne=td@'
...
ROOT_URLCONF = 'immerse_project.urls'
...
WSGI_APPLICATION = 'immerse_project.wsgi.application'


# Database
# https://docs.djangoproject.com/en/5.2/ref/settings/#databases

# immerse_project/settings.py
